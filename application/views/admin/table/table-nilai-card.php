                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-lg-end">
                                <a href="<?php echo base_url().'nilai/tambah_nilai_card/'.$kate.'/'.$wh ?>" class="btn btn-success"><i class="bi bi-plus"></i> Tambah Nilai</a>
                                <a href="<?php echo base_url().'nilai/cetak_data_nilai_card/'.$kate.'/'.$wh ?>" target="_blank" class="btn btn-primary me-1"><i class="bi bi-printer-fill"></i> Cetak Data</a>
                            </div>
                        </div>
                        <div class="card-body">
