                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?php echo base_url() . 'nilai/nilai_hapus/' . $p->id_kategori . '/' . $p->penilaian_id ?>" onclick="return confirm('Apakah anda ingin menghapus?')" class="btn btn-danger btn-sm">
