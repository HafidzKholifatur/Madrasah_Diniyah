                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="form-actions d-flex justify-content-start">
                                        ...
                                        <a href="<?php // echo base_url().'nilai/table_per_card/'.$p->id_kategori.'/'.$p->id_santri ?>" class="btn btn-info me-1"><i class="bi bi-printer"></i> Print Data</a>
                                        <a href="<?php echo base_url().'nilai/hapus_card_santri/'.$p->id_kategori.'/'.$p->id_santri ?>" class="btn btn-danger"><i class="bi bi-trash"></i> Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
