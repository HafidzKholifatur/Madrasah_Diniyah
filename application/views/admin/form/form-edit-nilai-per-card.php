    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Form yang bertujuan untuk mengedit data nilai
                    pengajian.</p>
            </div>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            ...
                                            <a href="<?php echo base_url().'nilai/table_per_card/'.$p->id_kategori.'/'.$p->id_santri ?>" class="btn btn-warning me-1 mb-1">Kembali</a>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
